 ...
 * @author Sergio
 */
public class LogicalXor1 extends BinaryOperation {
     ...
     * @throws Exception
     */
    public LogicalXor1(Operation leftOperation, Operation rightOperation) throws Exception {
...
//    }
    ...
    private class LogicalAndIterator extends UnpagedOperationIterator {
        ...
        protected Tuple findNextTuple() {
            ...
            boolean satisfied1 = leftOperation.exists(processedTuples, true);
            boolean satisfied2 = rightOperation.exists(processedTuples, true);
            if (satisfied1 ^ satisfied2) return fixedTuple;
