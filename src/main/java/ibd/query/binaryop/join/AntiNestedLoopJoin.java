 ...
 * @author Sergio
 */
public class AntiNestedLoopJoin extends Join {
     ...
     * @throws Exception
     */
    public AntiNestedLoopJoin(Operation leftOperation, Operation rightOperation, JoinPredicate joinPredicate) throws Exception {
