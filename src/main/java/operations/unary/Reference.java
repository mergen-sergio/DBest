...
public class Reference implements IOperator {
...
//        }
        ...
        ibd.query.Operation reference = null;
        try {
            reference = new ibd.query.unaryop.Reference(arguments.toArray(new String[0]));
        } catch (Exception ex) {
            ex.printStackTrace();
        }
        ...
        Operation.operationSetter(cell, operationName, arguments, reference);
