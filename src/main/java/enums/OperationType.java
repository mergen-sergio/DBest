...
//    INDEXER           (ConstantController.getString("operation.indexer"), "❶", "indexer", "indexer[args](source)", OperationArity.UNARY, IndexerForm.class, Indexer.class),
    ...
    SEMI_JOIN              (ConstantController.getString("operation.semiJoin"), "\u22C9", "semiJoin", "semiJoin[args](source1,source2)", OperationArity.BINARY, JoinForm.class, SemiJoin.class, false),
    ANTI_JOIN              (ConstantController.getString("operation.antiJoin"), "\u25B7", "antiJoin", "antiJoin[args](source1,source2)", OperationArity.BINARY, JoinForm.class, AntiJoin.class, false),
    LEFT_JOIN         (ConstantController.getString("operation.leftJoin"), "⟕", "leftJoin", "leftJoin[args](source1,source2)", OperationArity.BINARY, JoinForm.class, LeftJoin.class, false),
    RIGHT_JOIN        (ConstantController.getString("operation.rightJoin"), "⟖", "rightJoin", "rightJoin[args](source1,source2)", OperationArity.BINARY, JoinForm.class, RightJoin.class, false),
