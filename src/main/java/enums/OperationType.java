...
//    INDEXER           (ConstantController.getString("operation.indexer"), "❶", "indexer", "indexer[args](source)", OperationArity.UNARY, IndexerForm.class, Indexer.class),
    ...
    JOIN              (ConstantController.getString("operation.join"), "|X|", "join", "join[args](source1,source2)", OperationArity.BINARY, JoinForm.class, Join.class, false, false),
    ...
    SEMI_JOIN              (ConstantController.getString("operation.semiJoin"), "\u22C9", "semiJoin", "semiJoin[args](source1,source2)", OperationArity.BINARY, JoinForm.class, SemiLeftInnerJoin.class, false, false),
    ...
    ANTI_JOIN              (ConstantController.getString("operation.antiJoin"), "\u25B7", "antiJoin", "antiJoin[args](source1,source2)", OperationArity.BINARY, JoinForm.class, AntiLeftInnerJoin.class, false, false),
    ...
    LEFT_OUTER_JOIN         (ConstantController.getString("operation.leftOuterJoin"), "⟕", "leftOuterJoin", "leftOuterJoin[args](source1,source2)", OperationArity.BINARY, JoinForm.class, LeftOuterJoin.class, false, false),
    RIGHT_OUTER_JOIN        (ConstantController.getString("operation.rightOuterJoin"), "⟖", "rightOuterJoin", "rightOuterJoin[args](source1,source2)", OperationArity.BINARY, JoinForm.class, RightOuterJoin.class, false, false),
