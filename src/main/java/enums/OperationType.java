...
public enum OperationType {
    ...
    SCAN         (ConstantController.getString("operation.scan"), "→", "scan", "scan(source)", OperationArity.UNARY, null, Scan.class, false),
    ...
    PROJECTION        (ConstantController.getString("operation.projection"), "π", "projection", "projection[args](source)", OperationArity.UNARY, ProjectionForm.class, Projection.class, false),
...
//    AGGREGATION       (ConstantController.getString("operation.aggregation"), "\u22C8", "aggregation", "aggregation[args](source)", OperationArity.UNARY, AggregationForm.class, Aggregation.class, NO_ONE_ARGUMENT, PARENT_WITHOUT_COLUMN, NO_PREFIX),
        AGGREGATION       (ConstantController.getString("operation.aggregation"), "\u2211", "aggregation", "aggregation[args](source)", OperationArity.UNARY, AggregationForm.class, Aggregation.class, false),
    SORT              (ConstantController.getString("operation.sort"), "↕", "sort", "sort[args](source)", OperationArity.UNARY, SortForm.class, Sort.class, true),
//    INDEXER           (ConstantController.getString("operation.indexer"), "❶", "indexer", "indexer[args](source)", OperationArity.UNARY, IndexerForm.class, Indexer.class),
    ...
    HASH_JOIN              (ConstantController.getString("operation.hashJoin"), "#|X|", "hashJoin", "hashJoin[args](source1,source2)", OperationArity.BINARY, JoinForm.class, HashLeftInnerJoin.class, true),
    ...
    HASH_LEFT_SEMI_JOIN              (ConstantController.getString("operation.hashLeftSemiJoin"), "#\u22C9", "hashLeftSemiJoin", "hashLeftSemiJoin[args](source1,source2)", OperationArity.BINARY, JoinForm.class, HashLeftSemiJoin.class, true),
    HASH_RIGHT_SEMI_JOIN              (ConstantController.getString("operation.hashRightSemiJoin"), "#\u22CA", "hashRightSemiJoin", "hashRightSemiJoin[args](source1,source2)", OperationArity.BINARY, JoinForm.class, HashRightSemiJoin.class, true),
    ...
    HASH_LEFT_ANTI_JOIN              (ConstantController.getString("operation.hashLeftAntiJoin"), "#\u25B7", "hashLeftAntiJoin", "hashLeftAntiJoin[args](source1,source2)", OperationArity.BINARY, JoinForm.class, HashLeftAntiJoin.class, true),
    HASH_RIGHT_ANTI_JOIN              (ConstantController.getString("operation.hashRightAntiJoin"), "#\u25C1", "hashRightAntiJoin", "hashRightAntiJoin[args](source1,source2)", OperationArity.BINARY, JoinForm.class, HashRightAntiJoin.class, true),
    ...
    HASH_LEFT_OUTER_JOIN              (ConstantController.getString("operation.hashLeftOuterJoin"), "#⟕", "hashLeftOuterJoin", "hashLeftOuterJoin[args](source1,source2)", OperationArity.BINARY, JoinForm.class, HashLeftOuterJoin.class, true),  
    HASH_RIGHT_OUTER_JOIN        (ConstantController.getString("operation.hashRightOuterJoin"), "#⟖", "hashRightOuterJoin", "hashRightOuterJoin[args](source1,source2)", OperationArity.BINARY, JoinForm.class, HashRightOuterJoin.class, true),
    HASH_FULL_OUTER_JOIN        (ConstantController.getString("operation.hashFullOuterJoin"), "#⟗", "hashFullOuterJoin", "hashFullOuterJoin[args](source1,source2)", OperationArity.BINARY, JoinForm.class, HashFullOuterJoin.class, true),
    ...
    HASH             (ConstantController.getString("operation.hash"), "#", "hash", "hash(source)", OperationArity.UNARY, null, Hash.class,true),
    MEMOIZE             (ConstantController.getString("operation.memoize"), "\u2133", "memoize", "memoize(source)", OperationArity.UNARY, null, Memoize.class,false),
    ...
    UNILATERAL_EXISTENCE  (ConstantController.getString("operation.unilateralExistence"), "∃⟗", "unilateralExistence", "unilateralExistence(source)", OperationArity.BINARY, null, UnilateralExistence.class,false),
    BILATERAL_EXISTENCE  (ConstantController.getString("operation.bilateralExistence"), "∃⨝", "bilateralExistence", "bilateralExistence(source)", OperationArity.BINARY, null, BilateralExistence.class,false),
    
    APPEND             (ConstantController.getString("operation.append"), "+", "append", "append(source1,source2)", OperationArity.BINARY, null, Append.class,false),
    UNION             (ConstantController.getString("operation.union"), "∪", "union", "union(source1,source2)", OperationArity.BINARY, null, Union.class,false),
    ...
    INTERSECTION      (ConstantController.getString("operation.intersection"), "∩", "intersection", "intersection(source1,source2)", OperationArity.BINARY, null, Intersection.class, false),
    ...
    DIFFERENCE        (ConstantController.getString("operation.difference"), "-", "difference", "difference(source1,source2)", OperationArity.BINARY, null, Difference.class, false),
